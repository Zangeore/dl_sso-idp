...
return [
    ...
    'sp' => [
        ...
        'aHR0cDovL2xpbmstc2hvcnRlbmVyLmRsLmNvbQ==' => [
            'destination' => 'http://link-shortener.dl.com',
            'logout' => 'http://link-shortener.dl.com/logout',
        ]
    ...
    'events' => [
        'CodeGreenCreative\SamlIdp\Events\Assertion' => ['App\Listeners\SamlAssertionAttributesListener'],
